$(function() {
    ...
    $("form").submit(function(e) {
        ...
        // x, y, width, height
        const picData = [72, 62, 668, 588];
        // name, y
        const nameData = [username, 420];
        ...
        <section class="dp-container">
          ...
          <br>
          <a class="download-dp" href="${url}" download="MCF_DP_${username}">Download Image</a>
        <section>
      `;
            }
        });
    ...
    function createDP(username, imageUrl, pic, name, cb) {
        ...
        var frameImg = loadImage("src/img/framea.jpeg");
